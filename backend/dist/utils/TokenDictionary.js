...
exports.tokenDictionary = exports.TokenDictionaryService = exports.CANON_TOKEN_DICTIONARY = void 0;
/**
 * Canon Design System Token Dictionary
 * Extracted from analysis of SCSS files and Canon documentation
 */
exports.CANON_TOKEN_DICTIONARY = {
 ...
 */
class TokenDictionaryService {
    constructor(customDictionary) {
        this.dictionary = { ...exports.CANON_TOKEN_DICTIONARY, ...customDictionary };
    }
    /**
     * Get token definition by name
     */
    getTokenDefinition(tokenName) {
     ...
     */
    enhanceTokenInfo(tokenName, defaultCategory = 'raw') {
     ...
     */
    categorizeTokenByPattern(tokenName, defaultCategory) {
        // Color patterns
     ...
     */
    addTokenDefinition(tokenName, definition) {
        this.dictionary[tokenName] = definition;
    }
    /**
     * Update existing token definition
     */
    updateTokenDefinition(tokenName, updates) {
        if (this.dictionary[tokenName]) {
...
exports.TokenDictionaryService = TokenDictionaryService;
/**
 * Default instance for use throughout the application
 */
exports.tokenDictionary = new TokenDictionaryService();
