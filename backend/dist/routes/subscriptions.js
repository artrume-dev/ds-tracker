...
router.get('/', async (req, res) => {
    try {
        ...
        const subscriptions = await NotificationService_1.notificationService.getAllSubscriptions();
...
router.get('/:teamName', async (req, res) => {
    try {
        ...
        const subscription = await NotificationService_1.notificationService.getTeamSubscription(teamName);
        if (!subscription) {
...
router.post('/:teamName', async (req, res) => {
    try {
        ...
        // Save to database
        await NotificationService_1.notificationService.updateTeamSubscription(teamName, subscription);
        res.json({
            success: true,
...
router.post('/:teamName/test', async (req, res) => {
    try {
        ...
        const notificationId = await NotificationService_1.notificationService.createNotification({
            type: 'token_change',
...
router.post('/test-enhanced-email', async (req, res) => {
    try {
